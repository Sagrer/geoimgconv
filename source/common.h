...
//Объявления констант со всякими разными значениями по умолчанию. Значения см.
//в common.cpp . Так сделано чтобы эти значения существовали в программе в
//единственном экземпляре, т.к. если записать определения констант прямо в заголовке
//то по экземпляру констант будет во всех подключивших этот заголовок единицах
//компилляции.
