@rem Скрипт для установки 64-битной версии boost, собранной под 2017 студию.
...
@rem Можно начинать.
@echo This script will install boost for vs2017_x64 to directory:
...
:yes
cd %SRCDIR%
mkdir %DevLibsVs2017_x64%\include\boost
mkdir %DevLibsVs2017_x64%\lib
mkdir %DevLibsVs2017_x64%\lib64
xcopy .\boost %DevLibsVs2017_x64%\include\boost /E /Y
xcopy .\build_vs2017_x64\stage\lib %DevLibsVs2017_x64%\lib /E /Y
...
if exist %DevLibsVs2017_x64%\testfile2 (
	...
	for /r %%i in (.\build_vs2017_x64\stage\lib\*) do (
	...
	xcopy .\build_vs2017_x64\stage\lib %DevLibsVs2017_x64%\lib64 /E /Y
)
