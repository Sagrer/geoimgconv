@rem Скрипт для установки 64-битной версии gdal, собранной под 2017 студию.
...
@rem Можно начинать.
@echo This script will install GDAL for vs2017_x64 to directory:
...
:yes
set GDAL_HOME=%~dp0%srcdir%\vs2017_x64
cd %SRCDIR%
mkdir %DevLibsVs2017_x64%\include\gdal
mkdir %DevLibsVs2017_x64%\lib
mkdir %DevLibsVs2017_x64%\bin
mkdir %DevLibsVs2017_x64%\lib64
mkdir %DevLibsVs2017_x64%\bin64
xcopy %GDAL_HOME%\include %DevLibsVs2017_x64%\include\gdal /E /Y
xcopy %GDAL_HOME%\lib %DevLibsVs2017_x64%\lib /E /Y
xcopy %GDAL_HOME%\bin %DevLibsVs2017_x64%\bin /E /Y
...
if exist %DevLibsVs2017_x64%\testfile2 (
	...
	xcopy %GDAL_HOME%\lib %DevLibsVs2017_x64%\lib64 /E /Y
	xcopy %GDAL_HOME%\bin %DevLibsVs2017_x64%\bin64 /E /Y
)
