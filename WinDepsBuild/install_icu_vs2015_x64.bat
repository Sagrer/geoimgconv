@rem Скрипт установки 64-битной версии ICU, собранной под 2015 студию.
...
@rem Можно начинать.
@echo This script will install ICU for vs2015_x64 to directory:
...
:yes
cd %SRCDIR%
mkdir %DevLibsVs2015_x64%\include
mkdir %DevLibsVs2015_x64%\lib
mkdir %DevLibsVs2015_x64%\bin
mkdir %DevLibsVs2015_x64%\lib64
mkdir %DevLibsVs2015_x64%\bin64
xcopy .\include %DevLibsVs2015_x64%\include /E /Y
xcopy .\lib64 %DevLibsVs2015_x64%\lib /E /Y
xcopy .\bin64 %DevLibsVs2015_x64%\bin /E /Y
...
if exist %DevLibsVs2015_x64%\testfile2 (
	...
	xcopy .\lib64 %DevLibsVs2015_x64%\lib64 /E /Y
	xcopy .\bin64 %DevLibsVs2015_x64%\bin64 /E /Y
)
