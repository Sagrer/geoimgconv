@rem Скрипт для сборки ICU под 2017 студию.
@echo off
...
"%VS150COMNTOOLS%\..\IDE\devenv.com" .\source\allinone\allinone.sln /Clean "Debug|Win32"
@echo.
"%VS150COMNTOOLS%\..\IDE\devenv.com" .\source\allinone\allinone.sln /Clean "Release|Win32"
@echo.

@echo Building Debug...
@rem Собираем Debug-версию
"%VS150COMNTOOLS%\..\IDE\devenv.com" .\source\allinone\allinone.sln /Build "Debug|Win32"
@echo.
@rem release-версия
@echo Building Release...
"%VS150COMNTOOLS%\..\IDE\devenv.com" .\source\allinone\allinone.sln /Build "Release|Win32"
@echo.
...
@echo.
"%VS150COMNTOOLS%\..\IDE\devenv.com" .\source\allinone\allinone.sln /Rebuild "Release|Win32" /Project makedata
@echo.
:end
@echo.
@echo Build finished!
